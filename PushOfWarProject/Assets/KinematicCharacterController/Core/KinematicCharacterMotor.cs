...
#pragma warning restore 0414 
        ...
        /// <summary>
        /// Update phase 1 is meant to be called after kinematic movers have calculated their velocities, but
        ...
        /// <summary>
        /// Update phase 2 is means to be called after kinematic movers have simulated their goal positions/rotations. It is responsible for:
        ...
        private bool IsStableOnHit(Collider hitCollider, Vector3 hitNormal, Vector3 hitPoint)
        {
            ...
            if (StepAndLedgeHandling)
            {
                ...
                // Should we consider stepping/ledge handling?
                ...
                // Final result
                ledgeTestStable = !ledgeDetected || (Vector3.Project(_baseVelocity, ledgeNormal).magnitude < MaxStableOnLedgeVelocity && distanceFromLedge < MaxStableDistanceFromLedge);
            }
